...
__all__ = ['get_max_levels', 'get_perc_correct', 'add_implied_data', 'get_implied_perc_correct',
           ...
           'get_perc_correct_predicted_joint_r', 'fix_r_frame', 'get_perc_correct_predicted_joint', 'get_max_levels',
           'get_perc_correct', 'add_implied_data', 'get_implied_perc_correct', 'get_perc_correct_predicted_sep_r',
           'get_perc_correct_predicted_sep', 'get_perc_correct_predicted_sep_trial_r',
           'get_perc_correct_predicted_sep_trial', 'get_perc_correct_predicted_joint_r', 'fix_r_frame',
           'get_perc_correct_predicted_joint']
